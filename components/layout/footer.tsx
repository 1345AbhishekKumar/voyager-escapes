      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          <div>
            ...
            <p className="text-gray-400 mb-6 leading-relaxed">
              Luxury travel planning for discerning travelers seeking unforgettable experiences.
            </p>
          ...
          <div>
            ...
            <div className="grid grid-cols-3 gap-2">
              {[
                "https://images.unsplash.com/photo-1602002418082-dd4a3fd2d836?q=80&w=2874&auto=format&fit=crop",
                "https://images.unsplash.com/photo-1476514525535-07fb3b4ae5f1?q=80&w=2940&auto=format&fit=crop",
                "https://images.unsplash.com/photo-1530521954074-e64f6810b32d?q=80&w=2940&auto=format&fit=crop",
                "https://images.unsplash.com/photo-1504280390367-361c6d9f38f4?q=80&w=2940&auto=format&fit=crop",
                "https://images.unsplash.com/photo-1596394516093-501ba68a0ba6?q=80&w=2940&auto=format&fit=crop",
        ...
        <div className="border-t border-gray-800 mt-16 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm text-gray-400">
            &copy; {new Date().getFullYear()} Voyager Escapes. All rights reserved.
          </p>
